...
public class MaxPQ {
  ...
  /*This is our Priority Queue Implementation for the RUPA project. It takes a capacity and comparator paramter.
   * This allows us to sort the teams by the points, racetimes, etc.
   */
